...
<body>
    ...
    <!-- start header -->
    <header class="p-3 mb-3 bg-success bg-opacity-50 text-white border-bottom">
      <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
          ...
          <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
            <li><a href="index.php" class="nav-link px-2 link-dark fw-bold">Trang chủ</a></li>
            <li><a href="#" class="nav-link px-2 link-dark fw-bold">Sản phẩm</a></li>
            <li><a href="login.php" class="nav-link px-2 link-dark fw-bold">Quản lý</a></li>
